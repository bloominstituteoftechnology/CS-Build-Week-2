...
for (let c in roomGraph) {
    const room = new Room(c, "Treasure Spot", "Dig and you might find gold!", roomGraph[c][0], [], [], roomGraph[c][1], 30.0, [], [] );
    islandMap.push(room)
}
